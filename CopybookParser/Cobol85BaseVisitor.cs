...
public partial class Cobol85BaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ICobol85Visitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="Cobol85Parser.subscript"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitSubscript([NotNull] Cobol85Parser.SubscriptContext context) { return VisitChildren(context); }
	/// <summary>
